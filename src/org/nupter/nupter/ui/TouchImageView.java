...
import org.nupter.nupter.activity.TouchImageViewActivity;
...
public class TouchImageView extends ImageView {
    ...
    public TouchImageView(TouchImageViewActivity activity) {
        super(activity);
        gintama = BitmapFactory.decodeResource(getResources(), R.drawable.xianlin);
